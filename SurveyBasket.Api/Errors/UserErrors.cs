...
public static class UserErrors
{
    ...
    public static readonly Error InvalidEmailConfirmationCode = new("User.InvalidEmailConfirmationCode", "Invalid email confirmation code", StatusCodes.Status401Unauthorized);
    public static readonly Error DuplicatedConfirmation = new("User.DuplicatedConfirmation", "Email confirmation already used", StatusCodes.Status401Unauthorized);
}
